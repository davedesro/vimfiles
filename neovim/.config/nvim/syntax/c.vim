...
"syn match cLineSkip	"\\$"
syn cluster	cPreProcGroup	contains=cPreCondit,cIncluded,cInclude,cDefine,cDefined,cErrInParen,cErrInBracket,cUserLabel,cSpecial,cOctalZero,cCppOutWrapper,cCppInWrapper,@cCppOutInGroup,cFormat,cNumber,cFloat,cOctal,cOctalError,cNumbersCom,cString,cCommentSkip,cCommentString,cComment2String,@cCommentGroup,cCommentStartError,cParen,cBracket,cMulti,cBadBlock
...
"----
" syn match cDefined "\v\w@<!(\u|_+[A-Z0-9])[A-Z0-9_]*\w@!"
syn match cDefined "\v(\u|_+[A-Z0-9])[A-Z0-9_]*\w@!"
hi def link cDefined Number

syn match cOperators "[&|=!<>]"
hi def link cOperators cType
"-- 04/07/2019 DSD: From https://stackoverflow.com/questions/736701/class-function-names-highlighting-in-vim/773392
